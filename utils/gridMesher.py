...
class GridMesh:
    ...
    def initMesh(self):
        ...
        self.elemCenters = self.generatePoints() # resolution>1时，每个elem有resoution*resolution个elemCenters
    ...
    def generatePoints(self,  resolution = 1): # generate points in elements
        ...
        return xy;
    #-----------------------#
    def plotField(self, field, titleStr, filepath,
                  ...
                  penalMax,
                  alphaMax, res = 1):
        # x = field.reshape((res*self.nelx, res*self.nely)).T
